...
public static function clearbooking_reserve_custom_posts_meta_save($post_id,$post) {


$slug = 'clearbooking_rooms';


$slug1 = 'clearbooking_coupons';


$slug2 = 'clearbooking_add_ons';
...
if ( !empty( $_REQUEST['coupon_description'] ) ) {
...
if ( !empty( $_REQUEST['coupon_discount'] ) ) {
...
if ( !empty( $_REQUEST['add_on_name'] ) && $_POST['add_on_name'] != '' ) {
...
if ( !empty( $_REQUEST['add_on_description'] ) && $_POST['add_on_description'] != '' ) {
...
if ( !empty( $_REQUEST['add_on_price_thousands'] ) && $_POST['add_on_price_thousands'] != '' ) {
...
if ( !empty( $_REQUEST['add_on_price_cents'] ) && $_POST['add_on_price_cents'] != '' ) {
...
if ( !empty( $_REQUEST['add_on_frequency'] ) && $_POST['add_on_frequency'] != '' ) {
...
$table_name = $wpdb->prefix . 'clearbooking_add_ons';
...
if ( !empty( $_REQUEST['room_name'] ) && $_POST['room_name'] != '' ) {
        update_post_meta( $post_id, 'room_name', sanitize_text_field( $_REQUEST['room_name'] ) );
    }else{ wp_die( $wpdb->prefix . 'clearbooking_rooms', '' ) ; }

if ( !empty( $_REQUEST['room_description'] ) && $_POST['room_description'] != '' ) {
...
if ( !empty( $_REQUEST['room_occupancy'] ) && $_POST['room_occupancy'] != '') {
...
if ( !empty( $_REQUEST['room_price_thousands'] ) && $_POST['room_price_thousands'] != '' ) {
        update_post_meta( $post_id, 'room_price_thousands', sanitize_text_field( $_REQUEST['room_price_thousands'] ) );
    }else{ wp_die( 'Please enter the amount for this room ', '' ) ; }

if ( !empty( $_REQUEST['room_price_cents'] ) && $_POST['room_price_cents'] != '' ) {
